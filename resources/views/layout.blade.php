...
<body>
    ...
    <nav class="purple darken-2">
        <div class="nav-wrapper">
            ...
            <ul id="nav-user" class="right hide-on-med-and-down right_nav_panel">
            @if(Auth::user())
                    <li><a title="Моя команда" href="{{ route('user.teams') }}"><span class="material-icons">diversity_3</span></a></li>
                    <li><a href="{{ route('user.projects') }}"><span class="material-icons">folder</span></a></li>
{{--                    <li><a href="{{ route('tascs') }}"><span class="material-icons">task</span></a></li>--}}
                    <li><a href="{{ route('user.matrix') }}"><span class="material-icons">grid_view</span></a></li>
                    <li><a href="{{ route('user.canban') }}"><span class="material-icons">dashboard_customize</span></a></li>
                    <li><a href="{{ route('user.private') }}">{{Auth::user()->name}}</a></li>
